...
function fakeConfig(): PackagedConfig {
  return {
    ...
    namespaceBaseRoot: join("C:", "Users", "Fred", "AppData", "Roaming", "Creator Studio Design", "namespaces"),
    nodeCommand: null,
    posthogHost: null,
    posthogKey: null,
    resourceRoot: join("C:", "Program Files", "Creator Studio Design", "resources", "open-design"),
