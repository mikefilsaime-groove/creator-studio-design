...
export const ZH_CN_SKILL_COPY: Record<string, { description?: string; examplePrompt?: string }> = {
  ...
  'ui-ux-pro-max': {
    description:
      '仅目录索引的 UI/UX Pro Max 条目。完整的上游模板、数据和搜索工作流并未打包进 Creator Studio Design。',
    examplePrompt:
