...
export const zhTW: Dict = {
  ...
  "chat.amrCard.switchCta": "切換到 Creator Studio Design Cloud 並重試",
  ...
  "chat.runError.signInMessage.amr":
    "Creator Studio Design Cloud 智慧體尚未登入，前往登入即可正常使用",
  "chat.runError.signInMessage.other":
    "{agent}尚未登入，請在本機檢查登入狀態。推薦使用 Creator Studio Design Cloud 智慧體，更穩定划算",
  ...
  "artifact.odCardBrandAssistBody":
    "在瀏覽器中開啟品牌網站，讓 Creator Studio Design 繼續擷取此設計體系。",
