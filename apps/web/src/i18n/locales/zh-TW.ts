...
export const zhTW: Dict = {
  ...
  "chat.amrCard.switchCta": "切換到 Creator Studio Design Cloud",
  "chat.amrCard.switchedResend": "已切換至 Creator Studio Design Cloud，請重新傳送任務。",
  ...
  "chat.runError.cliSessionRefusedMessage": "Creator Studio Design 暫不支援目前的智能體版本，請更換為支援的版本後再試。",
  ...
  'home.amrGateUnavailable': '暫時無法確認 Creator Studio Design Cloud 額度，請重新傳送。',
