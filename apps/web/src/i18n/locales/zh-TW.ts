...
export const zhTW: Dict = {
  ...
  "fileViewer.publishFileRequiresWorkspace": "發布公開連結需要登入工作區。請登入 Creator Studio Design Cloud，或使用「部署」發布此檔案。",
  ...
  'campaign.deepseekV4Flash.boundary': '方案內的無限制模型額度與免費生成次數，僅可透過 Creator Studio Design 使用；無法在 MCP/CLI/API 及其他場景使用。解釋權歸官方所有。',
