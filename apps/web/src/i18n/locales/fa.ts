...
export const fa: Dict = {
  ...
  'chat.amrCard.switchCta': 'سوئیچ به Creator Studio Design Cloud و تلاش مجدد',
  ...
  'chat.runError.signInMessage.amr': 'عامل Creator Studio Design Cloud هنوز وارد نشده است — برای استفاده وارد شوید.',
  'chat.runError.signInMessage.other': '{agent} وارد نشده است. وضعیت ورود را به‌صورت محلی بررسی کنید. عامل Creator Studio Design Cloud را توصیه می‌کنیم — پایدارتر و مقرون‌به‌صرفه‌تر.',
  ...
  'entry.mailAria': 'به Creator Studio Design ایمیل بفرستید',
