...
export const fa: Dict = {
  ...
  'fileViewer.publishFileRequiresWorkspace': 'انتشار پیوند عمومی به ورود به یک فضای کاری نیاز دارد. به Creator Studio Design Cloud وارد شوید یا این فایل را با «استقرار» منتشر کنید.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'از ۶ تا ۱۳ اوت، کاربران پولی می‌توانند DeepSeek V4 Flash را در Creator Studio Design رایگان استفاده کنند. سوءاستفاده گسترده ممکن است دسترسی کمپین را متوقف کند.',
  'campaign.deepseekV4Flash.windowLabel': '۶–۱۳ اوت',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'یک هفته رایگان',
  'campaign.deepseekV4Flash.boundary': 'سهمیه نامحدود مدل و تعداد تولید رایگان پلن فقط داخل Creator Studio Design اعمال می‌شود — نه از طریق MCP، CLI، API یا سطوح دیگر. تفسیر نهایی با Creator Studio Design است.',
