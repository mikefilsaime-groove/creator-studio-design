...
export const fa: Dict = {
  ...
  'chat.amrCard.switchCta': 'سوئیچ به Creator Studio Design Cloud',
  "chat.amrCard.switchedResend": "به Creator Studio Design Cloud تغییر داده شد. لطفاً وظیفه را دوباره ارسال کنید.",
  ...
  "chat.runError.cliSessionRefusedMessage": "Creator Studio Design هنوز از این نسخهٔ عامل پشتیبانی نمی‌کند. به نسخه‌ای پشتیبانی‌شده تغییر دهید و دوباره امتحان کنید.",
  ...
  'home.amrGateUnavailable': 'تأیید موجودی Creator Studio Design Cloud ممکن نشد. دوباره ارسال کنید.',
