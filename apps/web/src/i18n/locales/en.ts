...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Creator Studio Design Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrError.authMessage': 'Your Creator Studio Design Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Creator Studio Design Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Creator Studio Design Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Creator Studio Design Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.title.signInRequired.amr': 'Creator Studio Design is not signed in',
  ...
  'chat.runError.title.runtimeConfig': "Creator Studio Design error",
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update Creator Studio Design to the latest version, which ships a compatible runtime.",
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} refused to start a session. The installed version is usually incompatible with Creator Studio Design — switch to a different version and retry.",
  ...
  'chat.runError.agentReplyIncompleteMessage': "The agent's reply came back without the marker Creator Studio Design needs to record this step, so the task couldn't move on. Nothing you sent was lost — this one is intermittent, and retrying usually goes through.",
  ...
  'settings.welcomeTitle': 'Welcome to Creator Studio Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Creator Studio Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Creator Studio Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the Creator Studio Design hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to Creator Studio Design',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to Creator Studio Design',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Creator Studio Design Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Creator Studio Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Creator Studio Design.',
  ...
  'settings.amrAccountStatus': 'Creator Studio Design Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose Creator Studio Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Creator Studio Design team',
  'settings.privacyConsentKicker': 'Help us improve Creator Studio Design',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how Creator Studio Design performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time Creator Studio Design starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but Creator Studio Design could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect Creator Studio Design to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Creator Studio Design is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in Creator Studio Design as context.',
  'settings.mcpRunningNote': 'Keep Creator Studio Design running. Restart your coding agent after setup.',
  ...
  'entry.discordAriaWithOnline': 'Join the Creator Studio Design Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow Creator Studio Design on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Creator Studio Design on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use Creator Studio Design Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss Creator Studio Design Cloud note",
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Creator Studio Design plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Creator Studio Design Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local Creator Studio Design project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Creator Studio Design Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Creator Studio Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Creator Studio Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Creator Studio Design',
  'pluginCard.contributeTitle': 'Contribute plugin to Creator Studio Design with a pull request',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Creator Studio Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Creator Studio Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Creator Studio Design everywhere',
  'useEverywhere.modalTitle': 'Use Creator Studio Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop Creator Studio Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Creator Studio Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Creator Studio Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Creator Studio Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Creator Studio Design at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive Creator Studio Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Creator Studio Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Creator Studio Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Creator Studio Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Creator Studio Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Creator Studio Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Creator Studio Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Creator Studio Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Creator Studio Design extras)',
  ...
  'entry.githubStarAria': 'Star Creator Studio Design on GitHub',
  ...
  'newproj.locationDefault': 'Creator Studio Design projects',
  ...
  'avatar.amrConsole': 'Creator Studio Design Cloud',
  ...
  'socialShare.openDesignSection': 'Share Creator Studio Design',
  'socialShare.openDesignTitle': 'Creator Studio Design on GitHub',
  'socialShare.openDesignText': 'Creator Studio Design is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Creator Studio Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Creator Studio Design: {title}\n{url}\nCreator Studio Design repo: {repo}',
  ...
  'brandEnrichment.body': "Creator Studio Design will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Creator Studio Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Creator Studio Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Creator Studio Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Creator Studio Design? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to Creator Studio Design on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Creator Studio Design on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Creator Studio Design on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to Creator Studio Design Cloud, or use a deploy option to share this file.',
  ...
  'assistant.shareToOpenDesign': 'Share to Creator Studio Design',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Creator Studio Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Creator Studio Design — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Creator Studio Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions Creator Studio Design should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'Creator Studio Design {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'Creator Studio Design is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'Creator Studio Design could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. Creator Studio Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Creator Studio Design',
  'updater.quitFailedBody': 'The installer is open, but Creator Studio Design could not quit. Quit Creator Studio Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Creator Studio Design will close and open the installer.',
  'updater.readyVersion': 'Creator Studio Design {version} is ready. Creator Studio Design will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. Creator Studio Design will close and open the installer.',
  'updater.reinstallReadyVersion': 'Creator Studio Design {version} requires a full reinstall. Creator Studio Design will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'Creator Studio Design {version} is here',
  ...
  'dsManager.createBody': 'Teach Creator Studio Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Creator Studio Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Creator Studio Design your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Creator Studio Design turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in Creator Studio Design. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside Creator Studio Design — not via MCP, CLI, API, or other surfaces. Final interpretation rests with Creator Studio Design. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve Creator Studio Design",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend Creator Studio Design to a colleague or friend?",
  ...
  'chat.designSystemStatus.description': 'Creator Studio Design is using the setup sources to generate this project.',
  ...
  'labs.harnessHint': "Your next generation will use Creator Studio Design's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness Creator Studio Design built for design work. Output is noticeably better in layout, structure, and completeness.",
