...
export const en: Dict = {
  ...
  'fileViewer.publishFileRequiresWorkspace': 'Publishing a public link needs a signed-in workspace. Sign in to Creator Studio Design Cloud, or use Deploy to publish this file.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 6–13, paid users can use DeepSeek V4 Flash for free in Creator Studio Design. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 6–13',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'one week free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside Creator Studio Design — not via MCP, CLI, API, or other surfaces. Final interpretation rests with Creator Studio Design.',
