...
export const en: Dict = {
  ...
  'chat.amrCard.switchCta': 'Switch to Creator Studio Design Cloud & retry',
  ...
  'chat.runError.signInMessage.amr': 'The Creator Studio Design Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Creator Studio Design Cloud agent — steadier and better value.',
