// Pre-run balance gate for the Creator Studio Design Cloud agent. There is exactly ONE
...
/**
 * Decide whether an Creator Studio Design Cloud run may start. Fast path first: the
