...
const OPEN_DESIGN_REPO_URL = 'https://github.com/mikefilsaime-groove/creator-studio-design';
const OPEN_DESIGN_REPO_LABEL = 'mikefilsaime-groove/creator-studio-design';
 ...
 * "Creator Studio Design" still yield a two-letter monogram ("OD").
 */
