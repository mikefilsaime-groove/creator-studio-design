...
const COMMUNITY_PAGE_PRESETS: ProjectPagePreset[] = [
  {
    ...
    category: 'prototype',
    title: pageText('Creator Studio Design Landing', 'Creator Studio Design 落地页', 'Creator Studio Design 落地頁'),
...
<body>
  <main>
    <section class="hero">
      <div>
        <div class="eyebrow">Creator Studio Design</div>
        <h1>${safeTitle}</h1>
        <p>${safeBody}</p>
      </div>
  ...
  <div class="deck-shell">
    <main class="deck-stage" id="deck-stage">
      <section class="slide active cover" data-screen-label="01 Cover">
        <div class="kicker">Creator Studio Design deck</div>
        <h1>${safeTitle}</h1>
...
<body>
  <article>
    <div class="meta">Creator Studio Design document</div>
    <h1>${safeTitle}</h1>
    <p>${safeBody}</p>
    <h2>Purpose</h2>
