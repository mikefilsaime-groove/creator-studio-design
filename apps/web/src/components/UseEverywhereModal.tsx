// Use Creator Studio Design Everywhere — modal entry that documents Creator Studio Design's
...
interface Props {
  ...
  daemonUrl?: string;
  /** Optional Creator Studio Design version string surfaced in the agent guide header. */
  versionHint?: string;
}
