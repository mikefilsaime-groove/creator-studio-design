...
// and assembles the Creator Studio Design logo (mark + wordmark, sampled from an SVG)
...
// the component can lazy-import it, defaults carry the Creator Studio Design wordmark and
