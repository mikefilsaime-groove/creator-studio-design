...
interface Props {
  ...
  /** Creator Studio Design Cloud profile from the warning snapshot; picks the console origin. */
  profile: string | null;
...
// SOFT pre-run reminder for Creator Studio Design Cloud tasks: the balance can still
