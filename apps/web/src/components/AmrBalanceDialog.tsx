...
// HARD pre-run blocker for Creator Studio Design Cloud tasks: the run cannot possibly
...
//
//   signed_out — Creator Studio Design Cloud selected but no account session. The CTA
...
export function AmrBalanceDialog({
  ...
  const openUpgrade = () => {
    ...
    // Same attribution handshake as the other Creator Studio Design Cloud handoffs
