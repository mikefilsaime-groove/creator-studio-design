 ...
 *  published by Creator Studio Design, and a plugin authored on this machine is the
...
<body>
  <main class="shell">
    ...
    <section class="sections">
      ...
      <div class="section"><b>Editable</b><span>Remix into a real Creator Studio Design project.</span></div>
    </section>
  </main>
</body>
</html>`;
