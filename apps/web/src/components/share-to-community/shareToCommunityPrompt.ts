// Trigger prompt for the post-completion "Share to Creator Studio Design" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an Creator Studio Design plugin so I can install it into My plugins and open a PR to the Creator Studio Design community catalog.',
  '',
