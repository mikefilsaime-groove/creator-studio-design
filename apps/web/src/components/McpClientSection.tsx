...
//
// Creator Studio Design connects to the configured servers as a CLIENT and surfaces
...
// so the most useful categories for Creator Studio Design (visual generation, then
