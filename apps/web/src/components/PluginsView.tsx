...
const PLUGIN_SHARE_DETAILS: Record<PluginShareAction, {
  ...
  'publish-github': {
    ...
    fallbackDescription:
      'Creates a public GitHub repository for this local Creator Studio Design plugin.',
    confirmLabel: 'Start publishing',
    steps: [
      'Create a new Creator Studio Design project for the publish workflow.',
  ...
  'contribute-open-design': {
    eyebrow: 'Creator Studio Design pull request',
    fallbackTitle: 'Contribute Plugin to Creator Studio Design',
    fallbackDescription:
      'Opens a pull request that adds this plugin to the Creator Studio Design community catalog.',
    confirmLabel: 'Start contribution',
    steps: [
      'Create a new Creator Studio Design project for the contribution workflow.',
      'Copy this plugin into that project as isolated source context.',
          ...
          {installedRecord ? (
            <section className="plugin-details-modal__section">
              ...
              <p className="plugin-details-modal__section-hint">
                This official catalog entry is bundled with Creator Studio Design and is ready to use.
              </p>
            </section>
          ) : (
            <section className="plugin-details-modal__section">
