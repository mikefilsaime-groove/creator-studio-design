...
function HtmlViewer({
  ...
  const handleHostPreviewNavigationFailure = useCallback((
    ...
    if (
      ...
      // the active Creator Studio Design Blob URL identifies the navigation that owns
  ...
  const captureExportImageSnapshot = useCallback(async (
    ...
    // never capture Creator Studio Design's own UI. Page exports use the selected preview
