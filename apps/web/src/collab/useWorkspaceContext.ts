...
/**
 * Whether an Creator Studio Design Cloud (AMR) run has a cloud identity that could pay
 * for it.
 *
...
export function useWorkspaceContext(): WorkspaceContextState {
   ...
   * Creator Studio Design Cloud" callout on screen for the whole (vela-backed,
