  ...
  AssistantMessage: ({
    ...
    <>
      ...
      {onShareToOpenDesign ? (
        ...
        >
          {shareToOpenDesignBusy ? 'Preparing package…' : 'Share to Creator Studio Design'}
        </button>
      ) : null}
    </>
  ),
...
- A clear DESIGN.md with all generated rules.`,
  ...
  it('keeps Share to Creator Studio Design busy on the assistant turn that started packaging', () => {
    ...
    rerender(
      <ChatPane
        ...
        messages={[
          ...initialMessages,
          { id: 'user-2', role: 'user', content: 'Share to Creator Studio Design', createdAt: 4 },
          {
            id: 'assistant-2',
            role: 'assistant',
            content: '',
