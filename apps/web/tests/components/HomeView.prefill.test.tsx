...
const AUTHORING_PLUGIN = {
  ...
  manifest: {
    ...
    od: {
      ...
      useCase: { query: 'Create an Creator Studio Design plugin for {{pluginGoal}}.' },
      inputs: [
        {
          name: 'pluginGoal',
          type: 'string',
...
const LIVE_ARTIFACT_PLUGIN = {
  ...
  manifest: {
    ...
    title: 'Live Artifact',
    description: 'Create refreshable, auditable Creator Studio Design artifacts.',
    od: {
      kind: 'scenario',
      taskKind: 'new-generation',
      mode: 'prototype',
      scenario: 'live',
      useCase: {
        query: 'Create refreshable, auditable Creator Studio Design artifacts backed by connector or local data.',
      },
      context: {
...
const AUTHORING_DEFAULT_SCENARIO_INPUTS = {
  artifactKind: 'Creator Studio Design plugin',
  audience: 'Creator Studio Design plugin authors',
  topic: 'packaging a reusable workflow as an Creator Studio Design plugin',
};
