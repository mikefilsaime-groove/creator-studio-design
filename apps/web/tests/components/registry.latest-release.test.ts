  ...
  it('reads the latest release metadata from the daemon endpoint', async () => {
    globalThis.fetch = vi.fn().mockResolvedValue({
      ...
      json: async () => ({
        ...
        html_url: 'https://github.com/mikefilsaime-groove/creator-studio-design/releases/tag/v0.8.0-prerelease.3',
    ...
    expect(result).toEqual({
      ...
      htmlUrl: 'https://github.com/mikefilsaime-groove/creator-studio-design/releases/tag/v0.8.0-prerelease.3',
      stale: false,
    });
  });
