...
describe('UserActionCard', () => {
  ...
  it('keeps full localized recovery labels actionable in the footer', () => {
        ...
        footerActions={
          <>
            <button type="button" onClick={onRecharge}>
              为 Creator Studio Design Cloud 充值
            </button>
            <button type="button" onClick={onRetry}>
              Retry the Creator Studio Design Cloud request
            </button>
          </>
        }
      />,
    ...
    const recharge = screen.getByRole('button', { name: '为 Creator Studio Design Cloud 充值' });
    const retry = screen.getByRole('button', {
      name: 'Retry the Creator Studio Design Cloud request',
    });
