 ...
 * 最新 OPEND-2807 / G16：CLI/BYOK 固定联系我们、导出日志、切换到 Creator Studio Design Cloud；
...
const CLOUD_CTA = '切换到 Creator Studio Design Cloud';
...
describe('OPEND-2807 · CLI/BYOK 主按钮固定切换到 Creator Studio Design Cloud', () => {
  it('按钮逐字使用工单和 G16 的「切换到 Creator Studio Design Cloud」', () => {
    renderFailure({ agentId: 'claude', code: 'AGENT_AUTH_REQUIRED' });
