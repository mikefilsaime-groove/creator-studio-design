...
function synthesizeSkill(candidate: SkillPluginCandidate): string {
  ...
  if (source) return `${source}\n\n## Provenance\n\nFormalized by Creator Studio Design from candidate ${candidate.id}.\n`;
  return [
    `# ${candidate.title}`,
    '',
    candidate.description,
    ...
    '## When to use',
    '',
    'Use this skill when the workflow described by the source material should be repeated inside Creator Studio Design.',
    '',
    '## Workflow',
    '',
