...
Creates one normal Creator Studio Design project artifact entry file through the local daemon.
When --project is omitted, the active Creator Studio Design project is used.
