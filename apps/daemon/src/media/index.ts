...
async function renderHyperFrames(
  ...
  try {
    if (usesHeadlessOverride) {
      ...
      throw new Error(
        'Creator Studio Design desktop frame renderer is unavailable. Open or upgrade the desktop client and try again.',
      );
    }
  ...
  return new Promise<void>((resolve, reject) => {
    ...
    const child = spawn(
      ...
      ],
      {
        ...
        // pinned HyperFrames CLI shipped with Creator Studio Design. Do not delegate
