...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · Creator Studio Design</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="Creator Studio Design">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">Creator Studio Design</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in Creator Studio Design.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to Creator Studio Design.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to Creator Studio Design.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to Creator Studio Design.';
        }
