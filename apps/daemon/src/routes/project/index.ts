...
function buildDesignSystemCopySourceContext(input: {
  ...
  return [
    ...
    '',
    'This design-system workspace was created from an existing Creator Studio Design project. Treat the copied project files as the primary source evidence for the generated design system.',
    '',
    '## Source project',
    '',
    ...
    '- Generate a reusable Creator Studio Design design-system package in this same project: DESIGN.md, README.md, SKILL.md, colors_and_type.css, context/provenance, focused preview cards, preserved assets/build/fonts when available, and ui_kits/app/.',
...
export function registerProjectRoutes(app: Express, ctx: RegisterProjectRoutesDeps) {
  ...
  app.post('/api/projects/:id/design-system-copy', async (req, res) => {
    ...
    try {
      ...
      const sourceNotes = `Created from Creator Studio Design project "${sourceProject.name}" (${sourceProject.id}).`;
