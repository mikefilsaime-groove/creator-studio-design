 ...
 *   (credentials, tool state, Creator Studio Design private bookkeeping). These must
 ...
 * no further Creator Studio Design change. A new `--exclude-dir` flag could NOT degrade
