...
/**
 * Promotes an AMR `retry` status update into a structured Creator Studio Design error
 ...
 * signals and promotes a match to a structured Creator Studio Design error payload.
