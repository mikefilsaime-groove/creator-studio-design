...
//
// 1. Provider BYOK is separate. It is used by Creator Studio Design's direct provider
...
export function spawnEnvForAgent(
  ...
  if (agentId === 'amr') {
    ...
    // Identify Creator Studio Design as the host so the vela CLI tags its command +
