...
/**
 * Exact Codex 0.147.0 tuple replayed by Creator Studio Design against the installed CLI
...
/**
 * Creator Studio Design-owned best-effort replay for the exact native OpenCode tuple.
...
/**
 * Creator Studio Design-owned replay of the exact Claude 2.1.233 Agent stream-json
