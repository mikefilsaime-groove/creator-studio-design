...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows Creator Studio Design's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# Creator Studio Design integration — MUST follow

You are running inside Creator Studio Design, a design tool. The user message contains
