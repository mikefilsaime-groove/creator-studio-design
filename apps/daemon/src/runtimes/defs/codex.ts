...
// `inherit = "core"` policy removes every Creator Studio Design wrapper variable, so a
...
// remain unavailable unless they are one of the explicit Creator Studio Design
 ...
 *
 *  - the Creator Studio Design shell-environment policy, byte-identical to the exec path,
