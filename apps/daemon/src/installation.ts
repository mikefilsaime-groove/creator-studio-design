...
// Locations:
//
//   packaged (mac):    ~/Library/Application Support/Creator Studio Design Prerelease/installation.json
//   packaged (win):    %APPDATA%/Creator Studio Design Prerelease/installation.json
//   packaged (linux):  $XDG_CONFIG_HOME/Creator Studio Design Prerelease/installation.json
