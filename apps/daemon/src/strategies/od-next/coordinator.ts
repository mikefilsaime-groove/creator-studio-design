 ...
 * ran the frozen plan, delivered a canonical entry Creator Studio Design resolved itself,
...
export function odNextTurnMayInferProductionCompletion(
  ...
  return task.inputStage === 'production'
    ...
    // Simple only. The inference rests on Creator Studio Design having resolved the
 ...
 * by evidence Creator Studio Design resolved itself, which is stronger than the agent's
