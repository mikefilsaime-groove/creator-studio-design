...
describe('agent-driven brand extraction engine', () => {
  ...
  it('prefers source-backed human brand tokens over script/debug color noise', () => {
    const brand = brandFromMaterial({
      ...
      siteName: 'Creator Studio Design',
      title: 'Creator Studio Design',
      description: 'Creator Studio Design design system.',
      colors: [
      ...
      fontFiles: [],
      logos: [],
      headings: ['Creator Studio Design The Open-source Claude Design alternative'],
      paragraphs: ['Creator Studio Design is a local-first design platform.'],
      navLabels: [],
      extraPages: [],
      screenshot: null,
      thin: false,
