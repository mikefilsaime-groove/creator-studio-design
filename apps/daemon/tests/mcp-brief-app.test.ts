...
describe('local Creator Studio Design MCP brief app', () => {
  ...
  it('keeps user-facing MCP copy on public Creator Studio Design product terms', () => {
    ...
    expect(userFacingCopy).toContain('Creator Studio Design Cloud');
