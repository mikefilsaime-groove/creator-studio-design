...
describe.skip('OPEND-2623 standing user constraint across a question-form answer', () => {
  ...
  it('does not order an unconditional file delivery on the production stage', () => {
    ...
    // The live wording: "Creator Studio Design must be able to identify one runnable entry
   ...
   *
   * Ask mode (`sessionMode: 'chat'`) is Creator Studio Design's shipped no-write mode.
