...
describe('connector routes', () => {
  ...
  it('returns branded callback HTML that notifies the opener', async () => {
    ...
    expect(html).toContain('Creator Studio Design');
    expect(html).toContain('open-design:connector-connected');
    expect(html).toContain('function requestClose()');
    expect(html).toContain('Your browser blocked automatic closing. You can close this tab and return to Creator Studio Design.');
