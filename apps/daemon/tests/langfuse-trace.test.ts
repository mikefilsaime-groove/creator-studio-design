...
describe('readTelemetrySinkConfig', () => {
  it('prefers the Creator Studio Design telemetry relay when configured', () => {
...
describe('reportRunCompleted', () => {
  ...
  it('POSTs serialized ingestion batches to the Creator Studio Design telemetry relay', async () => {
