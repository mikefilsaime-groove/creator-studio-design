...
describe('resolveDaemonPluginPreviewsDir', () => {
  it('resolves under the resource root in the packaged layout', () => {
    ...
    const resourceRoot = '/Applications/Creator Studio Design.app/Contents/Resources/open-design';
    const projectRoot = '/Applications/Creator Studio Design.app/Contents/Resources/app';
