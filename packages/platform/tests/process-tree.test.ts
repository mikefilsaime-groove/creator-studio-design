...
describe("processCommandExactlyRunsExecutable", () => {
  it("accepts exact POSIX and quoted Windows executable commands", () => {
    expect(processCommandExactlyRunsExecutable(
      "/Applications/Creator Studio Design.app/Contents/MacOS/Creator Studio Design",
      "/Applications/Creator Studio Design.app/Contents/MacOS/Creator Studio Design",
      "darwin",
    )).toBe(true);
    expect(processCommandExactlyRunsExecutable(
  ...
  it("rejects arguments and lookalike executable prefixes", () => {
    const executable = "/Applications/Creator Studio Design.app/Contents/MacOS/Creator Studio Design";
    ...
    const windowsExecutable = "C:\\Program Files\\Creator Studio Design\\Creator Studio Design.exe";
    expect(processCommandExactlyRunsExecutable(
