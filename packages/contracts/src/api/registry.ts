...
export type AgentFixIntent =
  ...
  | { kind: 'rescan' }
  /**
   * Prompt the user to point Creator Studio Design at an explicit binary by writing
...
export type AgentDiagnosticReason =
  ...
  /** The installed CLI version is outside this Creator Studio Design build's tested set. */
  | 'untested-version'
...
export interface AgentInfo {
  ...
  /** Whether models came from the installed CLI or Creator Studio Design's static fallback. */
