...
export const MEDIA_FAILURE_NEXT_STEPS = [
  ...
  'open-settings',
  /** The Creator Studio Design session behind an OD-owned model expired. */
  'sign-in',
...
/**
 * Run-scoped policy controlling Creator Studio Design-owned media generation only.
 *
...
/** Request for Creator Studio Design's deterministic local HyperFrames scaffold. */
