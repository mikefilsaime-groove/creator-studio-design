...
//
// Creator Studio Design acts as an MCP CLIENT here: the user configures one or more
...
export interface McpServerConfig {
   ...
   * every run. */
  enabled: boolean;
  /** HTTP/SSE only: whether Creator Studio Design should offer its managed OAuth flow.
