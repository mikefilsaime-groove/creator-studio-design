 ...
 * ownership sentinel that marks a base directory as Creator Studio Design-owned, refuses to
...
/**
 * Ensure `basePath` is an Creator Studio Design-owned managed base: create it if missing,
