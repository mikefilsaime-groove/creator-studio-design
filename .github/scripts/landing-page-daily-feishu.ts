...
function selfCheck(): void {
  ...
  const pull: LandingPull = {
    ...
    pull: {
      draft: false,
      html_url: "https://github.com/mikefilsaime-groove/creator-studio-design/pull/123",
  ...
  const card = buildCard({
    ...
    landingPulls: [pull],
    now,
    productionRun: { ...run, html_url: "https://github.com/mikefilsaime-groove/creator-studio-design/actions/runs/3", name: "landing-page-production", run_number: 11 },
