...
source_dmg="$RUNNER_TEMP/tools-pack/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/dmg/Creator Studio Design-$TOOLS_PACK_NAMESPACE.dmg"
source_zip="$RUNNER_TEMP/tools-pack/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/zip/Creator Studio Design-$TOOLS_PACK_NAMESPACE.zip"
...
versioned_dmg="creator-studio-design-${RELEASE_VERSION}${asset_suffix}-mac-x64.dmg"
versioned_zip="creator-studio-design-${RELEASE_VERSION}${asset_suffix}-mac-x64.zip"
