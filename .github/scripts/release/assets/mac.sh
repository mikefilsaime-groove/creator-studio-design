...
source_dmg="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/dmg/Creator Studio Design-$TOOLS_PACK_NAMESPACE.dmg"
source_zip="$tools_pack_dir/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/zip/Creator Studio Design-$TOOLS_PACK_NAMESPACE.zip"
...
versioned_dmg="creator-studio-design-${RELEASE_VERSION}${asset_suffix}-mac-arm64.dmg"
versioned_zip="creator-studio-design-${RELEASE_VERSION}${asset_suffix}-mac-arm64.zip"
...
release_notes="${RELEASE_NOTES:-Creator Studio Design $RELEASE_VERSION$asset_suffix}"
