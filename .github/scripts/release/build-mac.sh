...
capture_framework_diagnostics() {
  ...
  built_framework="$tools_pack_dir/out/mac/namespaces/$namespace/builder/mac-arm64/Creator Studio Design Beta.app/Contents/Frameworks/Electron Framework.framework"
