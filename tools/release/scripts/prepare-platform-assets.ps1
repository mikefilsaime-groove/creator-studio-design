...
$versionedInstaller = "creator-studio-design-$ReleaseVersion$ReleaseAssetSuffix-win-x64-setup.exe"
$versionedPayload = "creator-studio-design-$ReleaseVersion$ReleaseAssetSuffix-win-x64-payload.7z"
$versionedZip = "creator-studio-design-$ReleaseVersion$ReleaseAssetSuffix-win-x64-portable.zip"
...
$notes = if ([string]::IsNullOrWhiteSpace($ReleaseNotes)) {
  "Creator Studio Design $ReleaseVersion$ReleaseAssetSuffix"
} else {
  $ReleaseNotes
}
