...
describe("dogfood key minting", () => {
  it("pins every minted key under the dogfood root", () => {
    const objectKey = dogfoodObjectKey({ buildId: "1234-1", fileName: "Creator Studio Design-release-beta-win-setup.exe", version: "0.15.3-beta.7" });
    expect(objectKey).toBe("dogfood/0.15.3-beta.7/1234-1/Creator-Studio-Design-release-beta-win-setup.exe");
