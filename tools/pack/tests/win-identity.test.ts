...
describe("resolveWinInstallIdentity", () => {
  it("keeps the default namespace on the canonical Windows display name", () => {
    expect(resolveWinInstallIdentity({ namespace: "default" })).toMatchObject({
      displayName: "Creator Studio Design",
      shortcutName: "Creator Studio Design.lnk",
      uninstallerName: "Uninstall Creator Studio Design.exe",
    });
  });
  ...
  it("uses the canonical Windows display name for stable release namespaces", () => {
    expect(resolveWinInstallIdentity({ namespace: "release-stable-win" })).toMatchObject({
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Creator Studio Design.exe",
      displayName: "Creator Studio Design",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Creator Studio Design-release-stable-win",
      shortcutName: "Creator Studio Design.lnk",
      uninstallerName: "Uninstall Creator Studio Design.exe",
    });
  });
  ...
  it("uses first-class beta display identity for beta release namespaces", () => {
    expect(resolveWinInstallIdentity({ namespace: "release-beta-win" })).toMatchObject({
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Creator Studio Design Beta.exe",
      displayName: "Creator Studio Design Beta",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Creator Studio Design-release-beta-win",
      shortcutName: "Creator Studio Design Beta.lnk",
      uninstallerName: "Uninstall Creator Studio Design Beta.exe",
    });
  });
  ...
  it("keeps non-release beta-like namespaces isolated from the real beta channel identity", () => {
    expect(resolveWinInstallIdentity({ namespace: "beta-local-flow" })).toMatchObject({
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Creator Studio Design beta-local-flow.exe",
      displayName: "Creator Studio Design beta-local-flow",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Creator Studio Design-beta-local-flow",
      shortcutName: "Creator Studio Design beta-local-flow.lnk",
      uninstallerName: "Uninstall Creator Studio Design beta-local-flow.exe",
    });
  });
  ...
  it("uses first-class preview display identity for preview release namespaces", () => {
    expect(resolveWinInstallIdentity({ namespace: "release-preview-win" })).toMatchObject({
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Creator Studio Design Preview.exe",
      displayName: "Creator Studio Design Preview",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Creator Studio Design-release-preview-win",
      shortcutName: "Creator Studio Design Preview.lnk",
      uninstallerName: "Uninstall Creator Studio Design Preview.exe",
    });
  });
  ...
  it("uses first-class prerelease display identity for prerelease release versions and namespaces", () => {
    expect(resolveWinInstallIdentity({
      ...
      appPathsKey: "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\Creator Studio Design Prerelease.exe",
      displayName: "Creator Studio Design Prerelease",
      registryKey: "Software\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\Creator Studio Design-release-stable-win",
      shortcutName: "Creator Studio Design Prerelease.lnk",
      uninstallerName: "Uninstall Creator Studio Design Prerelease.exe",
    });
